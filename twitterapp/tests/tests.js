...
describe("wordFrequency()", function() {
  ...
  it("handles properties that exist on Object's prototype", function() {
    ...
    expect(wordFrequency("reserved words like prototype and toString ok?")).toEqual(expectedCounts);
  });
});
